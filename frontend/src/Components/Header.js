      ...
      <nav class="bg-white py-2 md:py-4">
        <div class="container px-4 mx-auto md:flex md:items-center">
          <div class="flex justify-between items-center">
            <span class="font-bold text-xl text-yellow-600">{props.stock}</span>
            <button
          ...
          >
            ...
            <span class="p-2 lg:px-4 md:mx-2 text-yellow-600 rounded hover:bg-white-200 hover:text-white-700 transition-colors duration-300">
              Stock Price : {price}
            </span>
            <span class="p-2 lg:px-4 md:mx-2 text-yellow-600 rounded hover:bg-yellow-200 hover:text-yellow-700 transition-colors duration-300">
              Total : {asset}
            </span>
            <span class="p-2 lg:px-4 md:mx-2 text-yellow-600 rounded hover:bg-yellow-200 hover:text-yellow-700 transition-colors duration-300">
              Shares : {props.share}
            ...
            <span class="p-2 lg:px-4 md:mx-2 text-yellow-600 rounded hover:bg-yellow-200 hover:text-yellow-700 transition-colors duration-300">
              Free Cash : {props.money.toFixed(2)}
            </span>
            <span class="p-2 lg:px-4 md:mx-2 text-yellow-600 rounded hover:bg-yellow-200 hover:text-yellow-700 transition-colors duration-300">
              {increase} $
            </span>
